...
namespace sistemaPlanMejoramientos.Logica
{
    public class ClInstructorL
    {
        ...
        public bool MtCrearInstructor(string tipoDocumento, string numeroDocumento,
            string nombres, string apellidos, string correo,
            string telefono, string especialidad, int idUsuario, int idCentro)
        {
            ...
            return oInstructorD.MtCrearInstructor(tipoDocumento, numeroDocumento,
        ...
        public bool MtActualizarInstructor(int idInstructor, string nombres, string apellidos,
            string correo, string telefono, string especialidad, int idCentro)
        {
            ...
            return oInstructorD.MtActualizarInstructor(
